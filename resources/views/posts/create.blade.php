        ...
        <div class="md:w-1/2 p-10  bg-white rounded-lg shadow-xl mt-10 md:mt-0"> 
            <form action="{{ route('posts.store') }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="titulo" id="titulo" placeholder="Titulo de publicacion" 
                ...
                <div class="mb-5">
                    ...
                    <textarea name="descripcion" id="descripcion" placeholder="Descripcion de publicacion" 
